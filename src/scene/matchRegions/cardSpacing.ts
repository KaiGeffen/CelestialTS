...
export function cardLocationTheirHand(state: ClientState, i: number): [number, number] {
...
// TODO Phaser container
export function cardLocationOurHand(state: ClientState, i: number, container): [number, number] {
	// X of the first card in their hand
	const x0 = 300
