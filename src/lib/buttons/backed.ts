...
// Exported buttons
export class AButtonSmall extends BackedButton {
	constructor(within: Phaser.Scene | Phaser.GameObjects.Container,
		x: number, y: number, text: string,
		f: () => void = function() {},
		playSound: boolean = true)
	{
		super(within, x, y, text, f, playSound, 'icon-ButtonA1')
	}
}

export class AButtonLarge extends BackedButton {
	constructor(within: Phaser.Scene | Phaser.GameObjects.Container,
		x: number, y: number, text: string,
		f: () => void = function() {},
		playSound: boolean = true)
	{
		super(within, x, y, text, f, playSound, 'icon-ButtonA2')
	}
}

export class SymmetricButtonSmall extends BackedButton {
	constructor(within: Phaser.Scene | Phaser.GameObjects.Container,
		x: number, y: number, text: string,
		f: () => void = function() {},
		playSound: boolean = true)
	{
		super(within, x, y, text, f, playSound, 'icon-Button1')
	}
}

export class SymmetricButtonLarge extends BackedButton {
	constructor(within: Phaser.Scene | Phaser.GameObjects.Container,
		x: number, y: number, text: string,
		f: () => void = function() {},
		playSound: boolean = true)
	{
		super(within, x, y, text, f, playSound, 'icon-Button2')
	}
}
