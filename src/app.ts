...
import { AnubisCatalogScene, RobotCatalogScene, StalkerCatalogScene } from "./scene/catalogScene"
...
const config: Phaser.Types.Core.GameConfig = {
  ...
  scene: [PreloadScene, WelcomeScene, CreditsScene, AnubisCatalogScene, RobotCatalogScene, StalkerCatalogScene, GameScene, BuilderScene, TutorialScene1, TutorialScene2],
  scale: {
